...
(function(){
  ...
  if(!container) return;
  const proofs=[
    {name:'Rajesh K',city:'Chennai',action:'enrolled in Index Options Pro',color:'#f5c842'},
    {name:'Karthik B',city:'Coimbatore',action:'joined Nifty Masterclass',color:'#00e5b0'},
    {name:'Sunitha D',city:'Madurai',action:'enrolled in Stock Options Course',color:'#00e5b0'},
    {name:'Murugan S',city:'Salem',action:'enrolled in Index Options Pro',color:'#f5c842'},
    {name:'Priya R',city:'Trichy',action:'joined Nifty Masterclass',color:'#00e5b0'},
    {name:'Arjun M',city:'Tiruppur',action:'enrolled in Stock Options Course',color:'#f5c842'},
    {name:'Deepa V',city:'Vellore',action:'enrolled in Index Options Pro',color:'#f5c842'},
    {name:'Senthil P',city:'Erode',action:'joined Nifty Masterclass',color:'#00e5b0'},
  ];
  let idx=0;
  function showToast(){
